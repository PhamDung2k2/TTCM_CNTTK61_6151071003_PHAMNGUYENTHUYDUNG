...
namespace QLNS.Controllers
{
    public class HopDongController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdHD,IdNV,TenHD,TuNgay,DenNgay")] HopDong hopDong)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdHD,IdNV,TenHD,TuNgay,DenNgay")] HopDong hopDong)
        {
            if (ModelState.IsValid)
            {
